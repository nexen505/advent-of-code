...
private inline fun Map<Int, Monkey>.goRounds(rounds: Int, levelOp: (Long) -> Long): Long {
    val monkeyLevels = (0..<size)
        .associateWith { 0L }
        .toMutableMap()
    repeat(rounds) {
        for (monkey in values) {
            for (item in monkey.items) {
                ...
                val destMonkey = this[destMonkeyIdx]!!
...
private fun part1(lines: List<String>): Long {
    ...
    return monkeys.goRounds(20) { it / 3 }
}
...
private fun part2(lines: List<String>): Long {
    ...
    return monkeys.goRounds(10000) { it % mod }
}
