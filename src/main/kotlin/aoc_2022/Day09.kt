...
private fun String.parse(): Pair<Direction, Int> {
    val (left, right) = split(' ')

    return Direction.parse(left.single()) to right.toInt()
}

private fun List<String>.parse(): List<Pair<Direction, Int>> = map { it.parse() }
...
fun main() {
    ...
    val testInput = readInput("aoc_2022/Day09_test")
    val input = readInput("aoc_2022/Day09")
