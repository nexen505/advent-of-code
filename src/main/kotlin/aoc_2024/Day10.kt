...
private fun part1(lines: List<String>): Int {
    val (map, trailheads, destinations) = lines.parse()

    return trailheads.sumOf { map.calculateScore(it, destinations) }
}

private data class Map(
    val map: List<List<Int>>,
    val trailheads: Set<Pair<Int, Int>>,
...
private fun List<String>.parse(): Map {
    ...
    val trailheads = map
        ...
        .toSet()
    val destinations = map.asSequence()
        .withIndex()
        .flatMap { (i, l) ->
            l.asSequence()
                .withIndex()
    ...
    return Map(map, trailheads, destinations)
}

private fun List<List<Int>>.calculateScore(
    start: Pair<Int, Int>,
...
private fun part2(lines: List<String>): Int {
    ...
    return trailheads.sumOf { map.calculateRating(it, destinations) }
}

private fun List<List<Int>>.calculateRating(
    start: Pair<Int, Int>,
    destinations: Set<Pair<Int, Int>>
): Int {
...
fun main() {
    val testInput = readInput("aoc_2024/Day10_test")
    val input = readInput("aoc_2024/Day10")
