...
fun main() {
    ...
    val testInput = readInput("aoc_2023/Day15_test")
    val input = readInput("aoc_2023/Day15")

    check(part1("HASH") == 52L)
    check(part1(testInput.first()) == 1320L)
    part1(input.first()).println()

    check(part2(testInput.first()) == 145L)
